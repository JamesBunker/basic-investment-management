...
public class Portfolio extends JFrame {
	...
	JTextArea welcomeMessage = new JTextArea(
		"Choose a command from the â€œCommandsâ€ menu to buy or sell an investment, update prices for all investments, get gain for the portfolio, search for relevant investments, or quit the program. ");
